cmd_arch/x86_64/kernel/mpparse.o := gcc -Wp,-MD,arch/x86_64/kernel/.mpparse.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/5/include -D__KERNEL__ -fno-stack-protector -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fno-stack-protector -fno-pie -O2  -mtune=generic -m64 -mno-red-zone -mcmodel=kernel -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -funit-at-a-time -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -maccumulate-outgoing-args   -fno-omit-frame-pointer -fno-optimize-sibling-calls -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign   -fno-stack-protector  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(mpparse)"  -D"KBUILD_MODNAME=KBUILD_STR(mpparse)" -c -o arch/x86_64/kernel/mpparse.o arch/x86_64/kernel/mpparse.c

deps_arch/x86_64/kernel/mpparse.o := \
...
arch/x86_64/kernel/mpparse.o: $(deps_arch/x86_64/kernel/mpparse.o)
