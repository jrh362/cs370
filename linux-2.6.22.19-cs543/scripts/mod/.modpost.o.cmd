cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -fno-stack-protector     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
